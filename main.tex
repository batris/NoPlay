...
\subsection{Detaching the Teaching Staff's Ability to Set the Pace}
Academic courses should surely make effective use of all the available course time. This might involve countering the human tendency to delay and procrastinate. One way to acheive this is to design tasks and provide support for a subject area under limited time in order oblige students to keep up the pace. Admittedly in a perfect pedagogical environment one might hope that the student could work at the pace that best suits their learning process. However, in practice a course will have a limited time span and a set curriculum to fit and assess within that time. Setting the pace will also allow the teacher to force the students to limit the time they spend on certain parts of the subject in order for them not to spend too much effort on trying to understand fully where only an general overview of the subject matter best suits the intended learning outcomes. Making recorded lecture material available may lead students to believe that they can always catch up by means of passive studies before any final summative examination, even when the course is designed to include elements of time critical formative assessment.
...
\subsection{Encouraging Studies in Isolation }
Studying together with peers has lately become a well studied pedagogical principle: Supplemental Instruction — Peer Assisted Study Sessions (SI - PASS).  There is certainly much that a course director can do in their course design to include actvities that encourage peer collaboration. Nevertheless, when lectures are recorded, not only are studies surely more likely to occur in isolation when choosing to follow recordeing rather than the even, studies are likley to be less synchronised in time with other students.  Recording of lectures may diminish the opportunities for normal advantageous synergistic meetings of peer students.  
...
``why not?''
 ...
 \subsection{Unclear Rights to the Material}
Pressure has been put onto staff to record lectures even though Stockholm University and unions are yet not in agreement on the many complicated issues concering the teacher's rights to such  material and how issues of suitable compensation and obligations to allow only correct and updated material to be part of future education.
